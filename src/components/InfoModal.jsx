    ...
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Info / Privacidad">
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          {section("Privacidad", <>
            {prose("Todos tus datos se guardan exclusivamente en el almacenamiento local del navegador. No se envía ninguna información a servidores externos. En modo incógnito o al limpiar los datos del navegador, estos se perderán.")}
          </>)}
