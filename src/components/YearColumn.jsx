...
export default function YearColumn({ year, yearIndex, selectedId, highlightMap, dimmedIds, statusMap, onCardClick, onOpenMenu, onSetStatus, onDelete, registerRef, arrowFilter, onArrowFilterChange, selectedSubject }) {
  return (
